    ...
    <>
      <section className="relative h-[40vh] md:h-[80vh] top-20 md:top-0 flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold leading-tight text-white drop-shadow-lg mt-4 md:mt-12">
            VOCÊ IMAGINA,<br /> 
            <span className="text-blue-300">NÓS FAZEMOS FUNCIONAR.</span>
          </h1>
          <p className="mt-2 md:mt-12 text-lg md:text-2xl text-blue-100 font-medium max-w-2xl drop-shadow">
